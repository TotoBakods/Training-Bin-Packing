...
- **Deliberate Planning with GPU Physics**: Uses a Packing Configuration Tree (PCT) and GPU-accelerated physics to reduce planning-time latency.
    - [Reference: Deliberate Planning of 3D Bin Packing on... (2025)](https://arxiv.org/abs/2504.04421)
...
- **HEPPO-GAE**: Extends PPO with graph-based state encoders and hardware-efficient training for improved sample efficiency.
    - [Reference: HEPPO-GAE: Hardware-Efficient Proximal Policy Optimization with Graph-Augmented Embeddings (2025)](https://arxiv.org/abs/2501.12703)
- **Multi-Objective RL for Combinatorial Optimization**: Uses constrained RL and reward-shaping to balance competing objectives like utilization and fragility.
    - [Reference: Reinforcement Learning Based Intelligent Optimization for... (2025)](https://www.sciencedirect.com/science/article/pii/S2590005625002437)
- **PPO-Driven Hyper-Heuristics**: Designs PPO-based hyper-heuristics that dynamically select from a set of low-level heuristics for improved robustness.
    - [Reference: A Proximal Policy Optimization Driven Hyper-Heuristic for... (2025)](https://www.sciencedirect.com/science/article/abs/pii/S1568494625013031)
...
- **Feedback-Driven DRL with PyBullet**: Shows that heuristic-seeded policies converge faster when using PyBullet-based feedback.
    - [Reference: A Physics-enabled Simulation Environment for Solution of O3D-BPP using Feedback-Driven DRL Technique (Jain et al., 2019)](https://translearn.github.io/assets/paper/TransLearn_2019_A_Physics-enabled_Simulation_Environment_for_Solution_of_O3D-BPP_using_)
...
- **Review of Physics Engines for RL**: Compares MuJoCo, PyBullet, Brax, Warp, and others for RL-driven tasks.
    - [Reference: A Review of Nine Physics Engines for Reinforcement Learning (2025)](https://arxiv.org/abs/2407.08590)
...
- **General Literature Review**: A review of various bin packing problem variants and solution strategies.
    - [Reference: A Literature Review on the Bin Packing Problem (2021)](https://www.scielo.org.mx/scielo.php?script=sci_arttext&pid=S1405-55462021000400002)
